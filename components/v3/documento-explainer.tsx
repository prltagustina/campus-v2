      ...
      <div className="relative overflow-hidden rounded-none md:rounded-3xl" style={{ backgroundColor: accent, color: accentText }}>
        ...
        {singleSlide ? (
          <div className="grid content-start gap-6 px-6 py-8 sm:gap-8 sm:px-10 sm:py-12 md:min-h-[730px] md:grid-cols-[1fr_1.3fr] md:content-center md:items-center md:px-20 md:py-16 xl:min-h-[640px]">
            ...
            <div>
              ...
              <div className="mt-5 flex flex-wrap items-center gap-3 sm:mt-7">
                ...
                <button type="button" onClick={share} aria-label={`Compartir ${titulo}`} className="grid h-11 w-11 place-items-center rounded-[9px] border-2 border-current text-current sm:h-12 sm:w-12">
          ...
          <div className="grid px-6 py-8 sm:px-10 sm:py-12 md:min-h-[520px] md:px-20 md:py-16 md:[&>*]:col-start-1 md:[&>*]:row-start-1">
            <div aria-hidden={slide !== 0} className={`content-start gap-6 sm:gap-8 md:grid md:grid-cols-[1fr_1.3fr] md:items-center ${slide === 0 ? "grid" : "hidden md:invisible"}`}>
