...
/** Pictograma curricular original usado por el prototipo para Áreas y Materiales. */
export function AreasMaterialsIcon({ className, ...props }: SVGProps<SVGSVGElement>) {
  return (
    <svg
      className={className}
      viewBox="0 0 48.52 52.44"
      fill="currentColor"
...
/** Tres ciclos representados por los tres anillos independientes de la maqueta. */
export function CycleMaterialsIcon({
  className,
  strokeWidth = 2,
  ...props
