...
export function MarcoGeneralSection() {
  return (
    <section id="marco-general" className="w-full py-20 md:py-32 bg-[#EDEDF0]">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-10">
            <div>
              ...
              <p className="text-[#494963]/50 text-lg mt-4 max-w-lg leading-relaxed">
            ...
            <Link
              href="/marco-general"
              className="inline-flex items-center gap-2 px-6 py-3 rounded-lg border border-[#494963]/20 text-[#494963] font-medium text-sm hover:border-[#494963]/40 hover:bg-[#494963]/5 transition-colors flex-shrink-0 self-start md:self-end"
            >
              {"Conocer mas"}
