...
function WheelBadge({ color }: { color: string }) {
  return (
    ...
    >
      <svg viewBox="0 0 48.52 52.44" className="w-4.5 h-4.5" fill={color} aria-hidden>
      ...
      <div className="w-full max-w-3xl mx-auto">
        <div className="flex flex-col sm:flex-row items-center gap-10 sm:gap-14">
          ...
          <div className="flex flex-col items-center sm:items-start text-center sm:text-left">
            ...
            {/* Title */}
            <h3 className="text-2xl sm:text-3xl md:text-[2rem] font-bold text-[#494963] leading-snug mb-3 text-balance font-display">
            ...
            <a
              href="#"
              className="inline-flex items-center gap-2.5 rounded-lg px-6 py-3 text-sm font-semibold transition-all hover:opacity-90 hover:shadow-md"
