 ...
 *
 * MOBILE: se fijan video, trama e histórica (su contenido entra en pantalla);
 * la descarga NO se fija porque su bajada de 3 párrafos la hace más alta que el
 * viewport y fijarla tapaba sus propios botones.
...
export default function HomePage() {
  return (
    <div className="bg-white">
      ...
      <div id="rueda" className={`${CARD} ${PIN_ALL} ${TOP} z-20 bg-[#F1F1F4] md:bg-white md:[&>section]:!pt-0`}><CurricularWheel /></div>
